...
@implementation Definitions(fenmkwlfmksdlmfklsdmfklfjdksfjfjdksfjkds)
...
+ (void)downloadImagesForURL:(id)url
{
    id filename = [url urlAsValidFilename];
